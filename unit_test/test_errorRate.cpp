...
TEST(getErrorRateIntervals, eq) {
  {
    ...
    EXPECT_FLOAT_EQ(getErrorRateIntervals(last, next), 0.5);
  }
  {
  ...
  }
  {
    ...
    EXPECT_FLOAT_EQ(getErrorRateIntervals(last, next), 0.005);
  }
  {
  ...
  }
  {
    ...
    EXPECT_FLOAT_EQ(getErrorRateIntervals(last, next), 0.01);
  }
  {
    Frames last{3000, 511};
    Frames next{4000, 531};
    EXPECT_FLOAT_EQ(getErrorRateIntervals(last, next), 0.02);
  }
  {
    Frames last{4000, 531};
    Frames next{5000, 561};
    EXPECT_FLOAT_EQ(getErrorRateIntervals(last, next), 0.03);
  }
}
...
TEST(getErrorRate, eq) {
  {
    ...
    EXPECT_FLOAT_EQ(er.getErrorRate(44), 0.05);
  }
  {
    ErrorRate er;
    er.setCurrent(0, {1000, 1});
    EXPECT_FLOAT_EQ(er.getErrorRate(), 0.001);
  }
  {
    ErrorRate er;
    er.setCurrent(0, {1000, 1});
    er.setCurrent(44, {45000, 500});
    EXPECT_FLOAT_EQ(er.getErrorRate(), 0.001);
  }
  {
    ErrorRate er;
    ...
    er.setCurrent(24, {25000, 2101});
    er.setCurrent(44, {45000, 2201});
    EXPECT_FLOAT_EQ(er.getErrorRate(48), 0.05);
  }
  {
    ErrorRate er;
    er.setCurrent(0, {1000, 1});
    ...
    EXPECT_FLOAT_EQ(er.getErrorRate(6), 0.02);
  }
  {
    ErrorRate er;
    er.setCurrent(0, {1000, 1});
    ...
    er.setCurrent(6, {4000, 531});
    er.setCurrent(8, {5000, 561});
    EXPECT_FLOAT_EQ(er.getErrorRate(6), 0.025);
  }
}